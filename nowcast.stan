...
transformed parameters {
  ...
  vector[t] branch_onsets; // onsets generated by the branching process
  vector[t] branch_reports; // reports generated by the branching process
...
model {
  ...
  for (i in 2:t) {
    noise[i] ~ normal(noise[i - 1], noise[i - 1] * 0.1) T[0,];
  }
  ...
  if (estimate_r == 1) {
    ...
    print("Reproduction no estimate")
    print(R)
